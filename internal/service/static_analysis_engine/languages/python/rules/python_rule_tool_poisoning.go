...
func NewToolPoisoningRule() static_analysis_engine.Rule {
...
func (r *ToolPoisoningRule) Evaluate(ast interface{}) ([]static_analysis_engine.Finding, error) {
...
func (r *ToolPoisoningRule) walkTree(node *sitter.Node, source []byte, findings *[]static_analysis_engine.Finding) {
	if node == nil {
		return
	}
...
func init() {
	static_analysis_engine.RegisterRule(static_analysis_engine.LanguagePython, NewToolPoisoningRule())
}
