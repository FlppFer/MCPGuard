...
func NewFileOperationsRule() static_analysis_engine.Rule {
...
func (r *FileOperationsRule) Evaluate(ast interface{}) ([]static_analysis_engine.Finding, error) {
...
func (r *FileOperationsRule) walkTree(node *sitter.Node, source []byte, findings *[]static_analysis_engine.Finding) {
	if node == nil {
		return
	}
...
func init() {
	static_analysis_engine.RegisterRule(static_analysis_engine.LanguagePython, NewFileOperationsRule())
}
