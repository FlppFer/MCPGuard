...
func NewIndirectInjectionRule() static_analysis.Rule {
...
func (r *IndirectInjectionRule) Evaluate(ast interface{}) ([]static_analysis.Finding, error) {
...
func (r *IndirectInjectionRule) walkTree(node *sitter.Node, source []byte, findings *[]static_analysis.Finding) {
	if node == nil {
		return
	}
...
func init() {
	static_analysis.RegisterRule(static_analysis.LanguagePython, NewIndirectInjectionRule())
}
