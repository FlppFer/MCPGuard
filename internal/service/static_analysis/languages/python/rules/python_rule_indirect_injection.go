...
func NewIndirectInjectionRule() model.Rule {
...
func (r *IndirectInjectionRule) Evaluate(ast interface{}) ([]model.Finding, error) {
...
func (r *IndirectInjectionRule) walkTree(node *sitter.Node, source []byte, findings *[]model.Finding) {
	if node == nil {
		return
	}
