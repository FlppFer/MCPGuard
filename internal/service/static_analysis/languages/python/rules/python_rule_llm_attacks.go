...
func NewLLMInherentAttackRule() static_analysis.Rule {
...
func (r *LLMInherentAttackRule) Evaluate(ast interface{}) ([]static_analysis.Finding, error) {
...
func (r *LLMInherentAttackRule) walkTree(node *sitter.Node, source []byte, findings *[]static_analysis.Finding) {
	if node == nil {
		return
	}
...
func init() {
	static_analysis.RegisterRule(static_analysis.LanguagePython, NewLLMInherentAttackRule())
}
