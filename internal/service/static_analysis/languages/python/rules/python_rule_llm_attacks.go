...
func NewLLMInherentAttackRule() model.Rule {
...
func (r *LLMInherentAttackRule) Evaluate(ast interface{}) ([]model.Finding, error) {
...
func (r *LLMInherentAttackRule) walkTree(node *sitter.Node, source []byte, findings *[]model.Finding) {
	if node == nil {
		return
	}
